...
**After implementing your API, please first test it locally before dockerization because debugging after dockerization will be much harder.** In this repo, you can just run `python server.py` (after installing all dependencies of course) to start the server. And then 
